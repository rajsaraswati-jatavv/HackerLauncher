...
class DataUsageTrackerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val usageGraphContainer: android.widget.FrameLayout = view.findViewById(R.id.usageGraphContainer)
        usageGraphView = UsageBarGraphView(requireContext())
        usageGraphContainer.addView(usageGraphView, android.widget.FrameLayout.LayoutParams(android.widget.FrameLayout.LayoutParams.MATCH_PARENT, android.widget.FrameLayout.LayoutParams.MATCH_PARENT))
