...
class CpuMonitorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val cpuGraphContainer: android.widget.FrameLayout = view.findViewById(R.id.cpuGraphContainer)
        cpuGraphView = CpuGraphView(requireContext())
        cpuGraphContainer.addView(cpuGraphView, android.widget.FrameLayout.LayoutParams(android.widget.FrameLayout.LayoutParams.MATCH_PARENT, android.widget.FrameLayout.LayoutParams.MATCH_PARENT))
