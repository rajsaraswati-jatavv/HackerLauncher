...
class NetworkSpeedMonitorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val speedGraphContainer: android.widget.FrameLayout = view.findViewById(R.id.speedGraphContainer)
        speedGraphView = SpeedGraphView(requireContext())
        speedGraphContainer.addView(speedGraphView, android.widget.FrameLayout.LayoutParams(android.widget.FrameLayout.LayoutParams.MATCH_PARENT, android.widget.FrameLayout.LayoutParams.MATCH_PARENT))
